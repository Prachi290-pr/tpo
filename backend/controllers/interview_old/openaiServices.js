...
exports.generateQuestions = async (complexity, language, numQuestions, role) => {
...
exports.evaluateAnswer = async (userAnswer, idealAnswer) => {
  try {
    const response = await openai.chat.completions.create({
      model: 'gpt-3.5-turbo',
      messages: [
...
// export default { generateQuestions, evaluateAnswer };
