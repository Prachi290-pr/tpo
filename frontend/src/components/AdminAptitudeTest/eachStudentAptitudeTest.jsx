...
const EachStudentAptitudeTest = ({ uid }) => {
  ...
  useEffect(() => {
    axios
      .post(`https://api.tpo.getflytechnologies.com/openai/history/${studentId.get("id")}`)
      .then((res) => {
  ...
  const handlequiz = (mcqKey) => {
    ...
    navigate("/admin-aptitude-details",{state:{mcqKey}})
...
export default EachStudentAptitudeTest;
