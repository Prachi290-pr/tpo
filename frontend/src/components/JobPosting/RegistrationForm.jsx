...
//         setAvailableSlabs(response.data);
//       } catch (err) {
...
//     setFormData({ ...formData, batch_date: value });
//     onFormDataChange({ ...formData, roles, batch_date: value });
//   };
...
//     <label className="block text-sm font-medium text-gray-700 mt-5 mb-2">Eligible Batches:</label>
//       <Autocomplete
//         multiple
//         id="checkboxes-tags-demo"
//         options={batchYears}
...
const RegistrationForm = ({ onFormDataChange }) => {
  ...
  const handleToggleChange = (e) => {
    setFormData({ ...formData, send_mail: e.target.checked });
  };
