...
//       try {
//         const response = await api.get("/forums/admin/jobpost");
...
//         <br />
//       {/* <h4 className="font-bold text-4xl  text-center text-indigo-700">JOB POSTS</h4> */}
//       <br />
...
//                 <th className="px-4 py-2 text-center text-sm font-medium text-white">Job Description</th>
//                 <th className="px-4 py-2 text-center text-sm font-medium text-white">Package Details</th>
//                 <th className="px-4 py-2 text-center text-sm font-medium text-white">Roles</th>
...
//                     <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => handleClick(post.id)}>
//                       Forum
//                     </button>
//                   </td>

//                   <td className="px-6 py-3">
//                     <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => handleDelete(post.id)}>
//                       Delete
//                     </button>
//                   </td>
//                 </tr>
...
//                     className={`px-3 py-1 rounded-md text-sm font-medium text-gray-600 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 text-white ${currentPage === index + 1 ? 'bg-gray-200 text-black' : ''}`}
//                   >
//                     {index + 1}
//                   </button>
//                 </li>
...
const ForumsDetails = ({ uid }) => {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmation === 'DELETE') {
      try {
        await api.post(`/forums/admin/jobpost/delete/${id}`);
  ...
  //     console.log(msg)
  //     // setChat((prevChat) => [...prevChat, `${msg.userId}: ${msg.message}`]);
  //   });
