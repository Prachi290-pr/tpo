...
const EventCompo = () => {
  ...
  const StdID = localStorage.getItem("uid"); // Placeholder student ID, adjust as needed

  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await nodeApi.get(`/getEligibleEvents/${localStorage.getItem("uid")}`);
              ...
              !event.isDeleted && (
                ...
                >
                  ...
                  <div className="mt-2">
                    ...
                    {event.banner && (
                      <img
                        src={`https://api.tpo.getflytechnologies.com/${event.banner}`}
                        alt="Event Banner"
                    ...
                    <p>
                      ...
                      {event.eventDeadline.split("T")[0]+" "+event.eventDeadline.split("T")[1].split(".")[0]}
                    </p>
                    <p>
                    ...
                    {openPayBoxes[index] && (
                      <>
                        ...
                        <a
                          ...
                          href={`https://api.tpo.getflytechnologies.com/${event.notice}`}
                          target="_blank"
