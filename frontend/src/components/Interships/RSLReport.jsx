...
const CompanySearchIntership = () => {
  ...
  const fetchCompanies = () => {
    api
      .get("rsl/intership/getcompanies")
      .then((res) => {
  ...
  const fetchRegistered = (companyId) => {
    api
      .get(`rsl/intership/getregistered/${companyId}`)
      .then((res) => {
        setData(res.data);
      })
      .catch((err) => {
...
export default CompanySearchIntership;
