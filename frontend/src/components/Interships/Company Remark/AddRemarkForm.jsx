...
const InternAddRemarkForm = ({ onAddRemark, showModal, setShowModal }) => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("dt",e)
    console.log("dt",driveDate)
    console.log("rdt",reminderDate)
    const newRemark = {
      text: text.trim(),
      status: status,
    ...
    console.log("dt",driveDate);
    console.log("rdt",reminderDate);
    console.log("one more remark:", newRemark);
...
export default InternAddRemarkForm;
