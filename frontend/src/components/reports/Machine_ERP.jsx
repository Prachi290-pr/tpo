...
const MachineERP = () => {
  ...
  const fetchERPCompanies = () => {
    api
      .get(`/erp/geterpcompanyreportMachine?id=${localStorage.getItem('AYearfor')}`)
      .then((res) => {
  ...
  const fetchERPEligible = () => {
    api
      .get("/erp/geterpeligibilityMachine")
      .then((res) => {
