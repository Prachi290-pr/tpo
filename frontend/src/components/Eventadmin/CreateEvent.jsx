...
function CreateEvent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formattedDeadlineDate = formData.eventDeadline;
  ...
  return (
    <div className="flex justify-center items-center ">
       <div className="w-full mt-10 lg:w-[80%]  p-8 border border-gray-300 shadow-md rounded-lg text-black">
