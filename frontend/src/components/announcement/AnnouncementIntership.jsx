...
const AnnouncementsIntership = () => {
  ...
  const fetchAnnouncements = async () => {
    try {
      const response = await api.get("announcements/intership");
  ...
  const fetchCompanies = async () => {
    try {
      const response = await api.get("companies/getCompaniesWithInterPostings");
  ...
  const handleAddAnnouncement = async () => {
    ...
    try {
      ...
      const response = await api.post("announcements/intership", newAnnouncementObj);
  ...
  const handleUpdateAnnouncement = async (id, msg) => {
    try {
      ...
      const res = await api.put(`announcements/intership/${id}`, {
        msg,
      });
  ...
  const handleDeleteAnnouncement = async (id) => {
    try {
      await api.delete(`announcements/intership/${id}`);
      setAnnouncements(
...
export default AnnouncementsIntership;
